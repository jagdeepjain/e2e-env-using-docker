...
class ConversionTest {
    ...
    void conversionF2CTest() {
        JsonPath conversion = given()
                ...
                .when()
                .get("http://localhost:7000/app/api/conversion/toCentigrade/100")
                .then()
                .statusCode(200)
                .extract()
                .jsonPath();
    ...
    void conversionF2ZeroCTest() {
        JsonPath conversion = given()
                .contentType("application/json")
                .when()
                .get("http://localhost:7000/app/api/conversion/toCentigrade/0")
                .then()
                .statusCode(200)
                .extract()
                .jsonPath();
    ...
    void conversionF2NegativeCTest() {
        JsonPath conversion = given()
                .contentType("application/json")
                .when()
                .get("http://localhost:7000/app/api/conversion/toCentigrade/-1")
                .then()
                .statusCode(200)
                .extract()
                .jsonPath();
    ...
    void conversionF2MoreThanIntSizeCTest() {
        given().when()
                .get("http://localhost:7000/app/api/conversion/toCentigrade/2147483648")
                .then().statusCode(404);
    }
    ...
    void conversionF2CAlphanumericInputTest() {
        given().when()
                .get("http://localhost:7000/app/api/conversion/toCentigrade/a")
                .then().statusCode(404);
    }
    ...
    void conversionF2CSpecialCharacterInputTest() {
        given().when()
                .get("http://localhost:7000/app/api/conversion/toCentigrade/$")
                .then().statusCode(404);
    }
    ...
    void conversionC2FTest() {
        given().when()
                .get("http://localhost:7000/app/api/conversion/toFahrenheit/37")
    ...
    void conversionC2ZeroFTest() {
        given().when()
                .get("http://localhost:7000/app/api/conversion/toFahrenheit/0")
    ...
    void conversionC2NegativeFTest() {
        given().when()
                .get("http://localhost:7000/app/api/conversion/toFahrenheit/-1")
    ...
    void conversionC2MoreThanIntSizeFTest() {
        given().when()
                .get("http://localhost:7000/app/api/conversion/toFahrenheit/2147483648")
                .then().statusCode(404);
    }
    ...
    void conversionAlphanumericInputTest() {
        given().when()
                .get("http://localhost:7000/app/api/conversion/toFahrenheit/a")
                .then().statusCode(404);
    }
    ...
    void conversionSpecialCharacterInputTest() {
        given().when()
                .get("http://localhost:7000/app/api/conversion/toFahrenheit/$")
                .then().statusCode(404);
    }
